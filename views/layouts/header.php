...
<head>
    ...
    <link rel="shortcut icon" href="/talkcloud/public/assets/images/favicon.ico" />
    <link rel="stylesheet" href="/talkcloud/public/assets/css/libs.min.css">
    <link rel="stylesheet" href="/talkcloud/public/assets/css/socialv.css?v=4.0.0">
    <link rel="stylesheet" href="/talkcloud/public/assets/vendor/@fortawesome/fontawesome-free/css/all.min.css">
    <link rel="stylesheet" href="/talkcloud/public/assets/vendor/remixicon/fonts/remixicon.css">
    <link rel="stylesheet" href="/talkcloud/public/assets/vendor/vanillajs-datepicker/dist/css/datepicker.min.css">
    <link rel="stylesheet" href="/talkcloud/public/assets/vendor/font-awesome-line-awesome/css/all.min.css">
    <link rel="stylesheet" href="/talkcloud/public/assets/vendor/line-awesome/dist/line-awesome/css/line-awesome.min.css">
            ...
            <div id="sidebar-scrollbar">
                <nav class="iq-sidebar-menu">
                    <ul id="iq-sidebar-toggle" class="iq-menu">
                        <li class="">
                            <a href="/talkcloud/public/index.php?action=feed" class=" ">
                                <i class="las la-newspaper"></i><span>Feed</span>
                            </a>
                        </li>
                        <li class="active">
                            <a href="/talkcloud/public/index.php?action=profile" class=" ">
                                <i class="las la-user"></i><span>Profile</span>
                            </a>
                        </li>
                        <li class=" ">
                            <a href="#mailbox" data-bs-toggle="collapse" class="  collapsed" aria-expanded="false">
                                <i class="ri-mail-line"></i><span>Posts</span><i
                                    class="ri-arrow-right-s-line iq-arrow-right"></i>
                            </a>
                            <ul id="mailbox" class="iq-submenu collapse" data-bs-parent="#iq-sidebar-toggle">
                                <li class="">
                                    <a href="/talkcloud/public/index.php?action=all-posts"><i class="  ri-inbox-line"></i>All Posts</a>
                                </li>
                                <li class="">
                                    <a href="/talkcloud/public/index.php?action=post-create"><i class="ri-edit-line"></i>Create Post</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <ul class="navbar-nav  ms-auto navbar-list">
                            ...
                            <li class="nav-item dropdown">
                                <a href="#" class="   d-flex align-items-center dropdown-toggle" id="drop-down-arrow" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <div class="caption">
                                        <h6 class="mb-0 line-height"><?= $_SESSION['user']['name'] ?></h6>
                                    </div>
                                </a>
                                    ...
                                    <div class="card shadow-none m-0">
                                        ...
                                        <div class="card-body p-0 ">
                                            ...
                                            <div class="d-inline-block w-100 text-center p-3">
                                                <a class="btn btn-primary iq-sign-btn" href="/talkcloud/public/index.php?action=logout" role="button">Sign
